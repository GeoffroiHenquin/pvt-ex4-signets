    ...
    <ul className="ListeDossiers">
      {
        ...
        <article className="Dossier" style={{backgroundColor: "#66bbbb"}}>
          <div className="couverture" style={{textAlign:'center',fontSize:100}}><h1 style={{marginTop:20}}>;-(</h1></div>
          <div className="info" style={{marginTop:-50}}><p>Aucun dossier ne se trouve dans votre librairie</p></div>
        </article>
      }
    </ul>
  );
